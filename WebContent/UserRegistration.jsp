				...
				<div style = padding:1px;width = 600px>
				 	...
				 	<table width = '100%'>
				 		...
				 		<tr> 					
				 			...
				 			<td>
				 			<select class="text_cray" id = "province" name="province" onchange="findcity()">
				 				<c:forEach items="${province.data}" var="s" varStatus="s1">
				 					<option value="<c:out value="${s.provinceid}"/>"><c:out value="${s.province}"/></option>
				 				</c:forEach>
				 			</select>
							城市：
				 		...
				 		<tr>
				 			...
				 			<td>
				 				<select class="text_cray" id = "certType" name="certType">
				 				<c:forEach items="${certType.data}" var="s" varStatus="s1">
				 					<option value="<c:out value="${s.id}"/>"><c:out value="${s.content}"/></option>
				 				</c:forEach>
				 				</select>
				 			</td>
				 		</tr>
